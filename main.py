...
# from category.add import add_category
# from category.show import show_category
from category.update import update_category
from category.delete import delete_category
                 ...
                 delete_category(categories)
                    ...
                    for i, category in enumerate(categories, start=1):
                        ...
                        # Update Product
                                ...
                                update_product(selected_category)


                    # Delete Product
                        elif product_choice == 4:

                                    delete_product(selected_category)
